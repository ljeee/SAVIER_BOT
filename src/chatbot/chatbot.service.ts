    ...
    try {
      ...
      if (lang === 'es') {
        systemPrompt = [
          ...
          '- Si la respuesta es una lista, devuélvela en una sola línea separada por comas (ejemplo: "cat1, cat2, cat3")',
          '',
        ...
        systemPrompt = [
          ...
          '- If the answer is a list, return it in a single line separated by commas (example: "cat1, cat2, cat3")',
          '',
          '=== DATABASE DATA ===',
          dbContext,
          '=== END OF DATA ===',
